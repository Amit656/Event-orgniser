...
api['data/calPost']  = ajax_path+"data/calPostId.php";
...
// noty notification  //Added Function to change callback on message type.
function noty_notification(image, message, url,fn) {
    new Noty({
        type: 'info',
        layout: 'bottomLeft',
        progressBar: 'true',
