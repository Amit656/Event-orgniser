...
/* Smarty version 3.1.33, created on 2020-03-13 14:20:16
  from '/var/www/html/qrsmusic/content/themes/default/templates/__feeds_post.body.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e6b96a036c345_75318989',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a68e641b31d2d0385a379f2f8414f87972c18648' => 
    array (
      0 => '/var/www/html/qrsmusic/content/themes/default/templates/__feeds_post.body.tpl',
      1 => 1573225137,
      2 => 'file',
    ),
  ),
...
function content_5e6b96a036c345_75318989 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/qrsmusic/includes/libs/Smarty/plugins/modifier.truncate.php','function'=>'smarty_modifier_truncate',),));
?>
<!-- post header -->
...
echo __("photo");
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['_post']->value['audio']['source2'] && $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio") {?>
						<?php echo __("midi");?>

                    <?php } elseif (substr($_smarty_tpl->tpl_vars['_post']->value['audio']['source'],-3) == "mid" && $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio") {?>
						<?php echo __("midi");?>
...
"><?php echo $_smarty_tpl->tpl_vars['_post']->value['album']['title'];?>
			...
			<?php } elseif ($_smarty_tpl->tpl_vars['_post']->value['audio']['source2'] && $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio") {?>
				<?php echo __("added multiple Audio Files");?>

			
			<?php } elseif (strpos($_smarty_tpl->tpl_vars['_post']->value['audio']['source'],"|") !== false && $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio" && $_smarty_tpl->tpl_vars['_post']->value['audio']) {?>
				<?php $_smarty_tpl->_assignInScope('source', explode("|",$_smarty_tpl->tpl_vars['_post']->value['audio']['source']));?>
								<?php if (isset($_smarty_tpl->tpl_vars['source']->value[3])) {?>
					<?php echo __("added Audio/Midi +");?>

				<?php } elseif (substr($_smarty_tpl->tpl_vars['source']->value[0],-3) == "mid" && substr($_smarty_tpl->tpl_vars['source']->value[1],-4) == "json") {?>
					<?php echo __("added Midi");?>
...
<?php } elseif (strpos($_smarty_tpl->tpl_vars['_post']->value['audio']['source'],"|") !== false && $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio" && $_smarty_tpl->tpl_vars['_post']->value['audio']) {?>
    <?php $_smarty_tpl->_assignInScope('source', explode("|",$_smarty_tpl->tpl_vars['_post']->value['audio']['source']));?>
	<?php $_smarty_tpl->_assignInScope('pid', $_smarty_tpl->tpl_vars['post']->value['post_id']);?>
	<?php if (substr($_smarty_tpl->tpl_vars['source']->value[0],-3) == "mid" && substr($_smarty_tpl->tpl_vars['source']->value[1],-4) == "json") {?>
		<div style="width:100%;height:100%;" width="100%" height="100%"><a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
/<?php echo $_smarty_tpl->tpl_vars['source']->value[0];?>
">Midi File </a>
		<canvas id="<?php echo $_smarty_tpl->tpl_vars['pid']->value;?>
" width="1000px" height="100px" style="overflow:hidden;;width:100%;height:100px"></canvas></div>	
	<?php } else { ?>
		<div style="width:100%;height:100%;" width="100%" height="100%"><a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
/<?php echo $_smarty_tpl->tpl_vars['source']->value[1];?>
">Midi File </a> | <a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
/<?php echo $_smarty_tpl->tpl_vars['source']->value[0];?>
">Audio File</a>
		<canvas id="<?php echo $_smarty_tpl->tpl_vars['pid']->value;?>
" width="1000px" height="100px" style="overflow:hidden;;width:100%;height:100px"></canvas></div>	
...
">
	...
	<?php }?>
	<?php if (isset($_smarty_tpl->tpl_vars['source']->value[2])) {?>
	<?php echo '<script'; ?>
 type="text/javascript">drawCanvas("<?php echo $_smarty_tpl->tpl_vars['pid']->value;?>
","<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
/<?php echo $_smarty_tpl->tpl_vars['source']->value[2];?>
")<?php echo '</script'; ?>
>
	<?php } elseif (isset($_smarty_tpl->tpl_vars['source']->value[1])) {?>
	<?php echo '<script'; ?>
 type="text/javascript">drawCanvas("<?php echo $_smarty_tpl->tpl_vars['pid']->value;?>
","<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
/<?php echo $_smarty_tpl->tpl_vars['source']->value[1];?>
...
>
	<?php }
} elseif (substr($_smarty_tpl->tpl_vars['_post']->value['audio']['source'],-3) == "mid" && $_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio" && $_smarty_tpl->tpl_vars['_post']->value['audio']) {?>
	<?php $_smarty_tpl->_assignInScope('pid', $_smarty_tpl->tpl_vars['post']->value['post_id']);?>
	<?php $_smarty_tpl->_assignInScope('source', explode("|",$_smarty_tpl->tpl_vars['_post']->value['audio']['source']));?>
    <div style="width:100%;height:100%;" width="100%" height="100%"><a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['_post']->value['post_type'] == "audio" && $_smarty_tpl->tpl_vars['_post']->value['audio']) {?>
    <div> 
		<a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
/<?php echo $_smarty_tpl->tpl_vars['_post']->value['audio']['source'];?>
">Audio File</a>
        <audio width="100%" class="js_mediaelementplayer">
            <source src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
