<?php
/* Smarty version 3.1.33, created on 2020-04-15 12:50:52
  from '/var/www/html/new_working_dir_QRS/trunk/qrsmusic/content/themes/default/templates/event.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e97032c746008_58093603',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fe8808ddf541b5545e2c10143ef5f0ce7d8552ef' => 
    array (
      0 => '/var/www/html/new_working_dir_QRS/trunk/qrsmusic/content/themes/default/templates/event.tpl',
      1 => 1586955051,
      2 => 'file',
    ),
  ),
...
function content_5e97032c746008_58093603 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/new_working_dir_QRS/trunk/qrsmusic/includes/libs/Smarty/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
...
" data-image="<?php echo $_smarty_tpl->tpl_vars['event']->value['event_cover'];?>
...
>
      function countdownTimer() {
        ...
        let difference = 0;
        let message = 'Session Begin In';

        if(+new Date("<?php echo $_smarty_tpl->tpl_vars['event']->value['event_start_date'];?>
") - +new Date() > 0)
        {
            difference = +new Date("<?php echo $_smarty_tpl->tpl_vars['event']->value['event_start_date'];?>
") - +new Date();
        }else{
            difference =  +new Date() - +new Date("<?php echo $_smarty_tpl->tpl_vars['event']->value['event_start_date'];?>
");
        ...
        let countdown_string = '<h4>'+message+'</h4>';


        if(days > 0){
            countdown_string += '<div>';
            countdown_string += '<span class="days">'+days+'</span>';
            countdown_string += '<div class="smalltext">Days</div>';
            countdown_string += '</div>';
        }
        
        countdown_string += '<div>';
        countdown_string += '<span class="hours">'+hours+'</span>';
        countdown_string += '<div class="smalltext">Hours</div>';
        countdown_string += '</div>';
        countdown_string += '<div>';
        countdown_string += '<span class="minutes">'+minutes+'</span>';
        countdown_string += '<div class="smalltext">Minutes</div>';
        countdown_string += '</div>';
        countdown_string += '<div>';
        countdown_string += '<span class="seconds">'+seconds+'</span>';
        countdown_string += '<div class="smalltext">Seconds</div>';
        countdown_string += '</div>';

        document.getElementById("clockdiv").innerHTML = countdown_string;
      }
