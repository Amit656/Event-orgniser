<?php
/* Smarty version 3.1.33, created on 2020-03-12 16:23:00
  from '/var/www/html/qrsmusic/content/themes/default/templates/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e6a61e4df0534_15535887',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '178f358f4045f3222e616a1a50f85f560db3f588' => 
    array (
      0 => '/var/www/html/qrsmusic/content/themes/default/templates/settings.tpl',
      1 => 1573225137,
      2 => 'file',
    ),
  ),
...
function content_5e6a61e4df0534_15535887 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/qrsmusic/includes/libs/Smarty/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
...
/settings/profile/other">
                        ...
                        <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "secuirty") {?>class="active"<?php }?>>
                            <a href="#secuirty-settings" data-toggle="collapse" <?php if ($_smarty_tpl->tpl_vars['view']->value == "secuirty") {?>aria-expanded="true"<?php }?>>
                                <i class="fa fa-shield-alt fa-fw mr10" style="color: #8bc34a"></i><?php echo __("Secuirty Settings");?>

                            </a>
                            <div class='collapse <?php if ($_smarty_tpl->tpl_vars['view']->value == "secuirty") {?>show<?php }?>' id="secuirty-settings">
                                <ul>
                                    <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "secuirty" && $_smarty_tpl->tpl_vars['sub_view']->value == "password") {?>class="active"<?php }?>>
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/secuirty/password">
                                            <?php echo __("Password");?>

                                        </a>
                                    </li>
                                    <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "secuirty" && $_smarty_tpl->tpl_vars['sub_view']->value == "sessions") {?>class="active"<?php }?>>
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/secuirty/sessions">
                                            <?php echo __("Manage Sessions");?>

                                        </a>
                                    </li>
                                    <?php if ($_smarty_tpl->tpl_vars['system']->value['two_factor_enabled']) {?>
                                        <li <?php if ($_smarty_tpl->tpl_vars['view']->value == "secuirty" && $_smarty_tpl->tpl_vars['sub_view']->value == "two-factor") {?>class="active"<?php }?>>
                                            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/secuirty/two-factor">
...
">
                            ...
                            <!-- success -->
                            <div class="alert alert-success mb0 x-hidden" role="alert"></div>
                            <!-- success -->

                            <!-- error -->
                            <div class="alert alert-danger mb0 x-hidden" role="alert"></div>
                            <!-- error -->
                        </div>
...
?>
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "secuirty") {?>
