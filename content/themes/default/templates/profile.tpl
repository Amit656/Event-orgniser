            ...
            <div class="profile-header">
                ...
                <div class="profile-cover-wrapper">
                    {if $profile['user_cover_id']}
                        ...
                        <!-- cropped-cover -->
                        <img class="js_position-cover-cropped js_lightbox" data-init-position="{$profile['user_cover_position']}" data-id="{$profile['user_cover_id']}" data-image="{$profile['user_cover']}" data-context="album" src="{$profile['user_cover']}" alt="{$profile['user_firstname']} {$profile['user_lastname']}">
                        <!-- cropped-cover -->
                    {/if}
