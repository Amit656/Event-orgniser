            ...
            <div class="profile-header no-avatar">
                ...
                <div class="profile-cover-wrapper">
                    {if $event['event_cover_id']}
                        ...
                        <!-- cropped-cover -->
                        <img class="js_position-cover-cropped js_lightbox" data-init-position="{$event['event_cover_position']}" data-id="{$event['event_cover_id']}" data-image="{$event['event_cover']}" data-context="album" src="{$event['event_cover']}" alt="{$event['event_title']}">
                        <!-- cropped-cover -->
                    {/if}
...
<script>
      function countdownTimer() {
        ...
        if(+new Date("{$event['event_start_date']}") - +new Date() > 0)
        {
            difference = +new Date("{$event['event_start_date']}") - +new Date();
        }else{
            difference =  +new Date() - +new Date("{$event['event_start_date']}");
