            ...
            <div class="card">
                <div class="card-body with-nav">
                    <ul class="side-nav">
                        ...
                        <li {if $view == "secuirty"}class="active"{/if}>
                            <a href="#secuirty-settings" data-toggle="collapse" {if $view == "secuirty"}aria-expanded="true"{/if}>
                                <i class="fa fa-shield-alt fa-fw mr10" style="color: #8bc34a"></i>{__("Secuirty Settings")}
                            </a>
                            <div class='collapse {if $view == "secuirty"}show{/if}' id="secuirty-settings">
                                <ul>
                                    <li {if $view == "secuirty" && $sub_view == "password"}class="active"{/if}>
                                        <a href="{$system['system_url']}/settings/secuirty/password">
                                            {__("Password")}
                                        </a>
                                    </li>
                                    <li {if $view == "secuirty" && $sub_view == "sessions"}class="active"{/if}>
                                        <a href="{$system['system_url']}/settings/secuirty/sessions">
                                            {__("Manage Sessions")}
                                        </a>
                                    </li>
                                    {if $system['two_factor_enabled']}
                                        <li {if $view == "secuirty" && $sub_view == "two-factor"}class="active"{/if}>
                                            <a href="{$system['system_url']}/settings/secuirty/two-factor">
