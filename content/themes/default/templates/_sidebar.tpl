    ...
    <div class="card-body with-nav">
        <ul class="main-side-nav">
            ...
            <li>
             ...
             <li>
                <a href="{$system['system_url']}/calendar">
            ...
            <li>
                <a href="{$system['system_url']}/devices">
            ...
            <li>
                <a href="{$system['system_url']}/gear">
                    <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/synth.png">
                    {__("Gear")}
                </a>
            </li>
            ...
            <li>
                <a href="{$system['system_url']}/activities">
            ...
            <li>
                <a href="{$system['system_url']}/reports">
                    <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/reports.png">
                    {__("Reports")}
                </a>
            </li>
