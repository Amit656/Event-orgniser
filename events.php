...
try {
	...
	switch ($_GET['view']) {
		...
		case '':
			...
			// $user->pushNotificationBeforeSessionStart(array('suggested' => true));
			// exit;
			
			/* assign variables */
			$smarty->assign('events', $_GET['view']);
			$smarty->assign('events', $events);
			$smarty->assign('get', "suggested_events");

			$allUsers = $user->getAllUserFriendsList($user->_data['user_id'], true);
			$AllSessionTypes = $user->getAllSessionTypes();
			$smarty->assign('allUsers', $allUsers);
			$smarty->assign('AllSessionTypes', $AllSessionTypes);
			break;
